<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="最近登录ip地址" align="center" prop="lastLoginIp" />
      <el-table-column label="个性签名" align="center" prop="signature" />
      <el-table-column label="删除状态" align="center" prop="deletd" />
  ...
  data() {
    return {
      ...
      rules: {
        ...
        lastLoginIp: [
          { required: true, message: "最近登录ip地址不能为空", trigger: "blur" }
        ],
      }
    };
  },
